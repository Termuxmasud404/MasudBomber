...
import os
import shutil
import .data "/data/data/com.termux/files/home/MasudBomber/MasudBomber/MBomb.py"
#ok
#MBomb
...
def update():
    ...
    os.system("cd .. && cd MasudBomber && python Mbomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : MASUD                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : Termux-Masud \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Masud404              \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mMasudBomber\n")
        time.sleep(0.6)
...
#Get Target Number
def getNumber():
    number = input("\n    \033[92m[\033[37m*\033[92m] Enter BD Target Number:> \033[37m")
    try:
        int(number)
    except:
...
def main():
    ...
    amount = input("    \033[92m[\033[37m*\033[92m] Enter Amount (\033[37mDefault: 100\033[92m):> \033[37m")
    try:
        amount = int(amount)
    except:
        amount = 10
